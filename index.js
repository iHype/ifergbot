    ...
    if(cmd === `${prefix}trackfortnite`){
        ...
        function callback(error, response, body) {
            ...
            if (!info.error && response.statusCode == 200) {
                ...
                .addField(`${info.lifeTimeStats[1].key}`, `${info.lifeTimeStats[1].value}`)
                .addField(`${info.lifeTimeStats[2].key}`, `${info.lifeTimeStats[2].value}`)
                .addField(`${info.lifeTimeStats[3].key}`, `${info.lifeTimeStats[3].value}`)
                .addField(`${info.lifeTimeStats[4].key}`, `${info.lifeTimeStats[4].value}`)
                .addField(`${info.lifeTimeStats[5].key}`, `${info.lifeTimeStats[5].value}`)
                .addField(`${info.lifeTimeStats[6].key}`, `${info.lifeTimeStats[6].value}`)
                .addField(`${info.lifeTimeStats[7].key}`, `${info.lifeTimeStats[7].value}`)
                .addField(`${info.lifeTimeStats[8].key}`, `${info.lifeTimeStats[8].value}`)
                .addField(`${info.lifeTimeStats[9].key}`, `${info.lifeTimeStats[9].value}`)
                .addField(`${info.lifeTimeStats[10].key}`, `${info.lifeTimeStats[10].value}`)
